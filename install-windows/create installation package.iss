...
#define MyAppName "Turbo Diagram"
#define MyAppVersion "0.2"
#define MyAppPublisher "pekand@gmail.com"
#define MyAppURL "http://www.pekand.ccom"
...
OutputBaseFilename=tdiagram
SetupIconFile=versions\0.2.004\Diagram.ico
Compression=lzma
...
[Files]
Source: "versions\0.2.004\Diagram.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "versions\0.2.004\diagram.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "versions\0.2.004\Ciloci.Flee.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "versions\0.2.004\Ciloci.Flee.xml"; DestDir: "{app}"; Flags: ignoreversion
Source: "versions\0.2.004\ScintillaNET.dll"; DestDir: "{app}"; Flags: ignoreversion
